...
workspace="OpenAR.xcworkspace"
scheme="Ad Hoc"
info_plist="$project_dir/OpenAR-Info.plist"
...
cp -v "OpenAR/$environment_info_plist" $info_plist || failed environment_plist
#copy the environment settings plist into place
cp -v "OpenAR/$environment_plist" "OpenAR/environment.plist" || failed environment
